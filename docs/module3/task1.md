...
Обратите внимание, .env-файл не должен попадать в систему контроля версий. Его не нужно коммитить. Вы можете добавить дополнительный файл .env-example, в котором привести пример заполненного файла. Он не должен содержать конфиденциальных сведений и его можно коммитить.
